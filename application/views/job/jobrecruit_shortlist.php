			...
			<div class="row">
				<div class="col-sm-12 page-content">
					<div class="title-lines">
						<h3 class="mt0">Shortlisted Candidates</h3>
					</div>

					<div class="clearfix mb30">							
							<a href="<?=base_url();?>jobs_recruit/job_candidates/<?=$this->uri->segment(3);?>" class="btn btn-gray">View all Candidates</a>
					</div>
					<?php if($jobshortlistquery->num_rows() < 1): ?>
						<p>No candidate Selected.</p>
					<?php endif; ?>
					<?php if($jobshortlistquery->num_rows() > 0): ?>
								<?php foreach($jobshortlistquery->result() as $row): ?>
					<div class="candidates-item">						
						...
						<ul class="top-btns">
							...
							<li><a href="<?=base_url();?>jobs_recruit/job_unshortlisted/<?=$row->application_id?>" class="btn btn-gray fa fa-times" title="Deselect Candidate"></a></li>
						</ul>
