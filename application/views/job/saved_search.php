		...
		<div class="container">
			<div class="row">
				<div class="col-sm-8 page-content">
					...
					<?php if($candidatesavesquery->num_rows() > 0): ?>
								<?php foreach($candidatesavesquery->result() as $row): ?>
					<div class="jobs-item with-thumb row brown-container">
						...
						<div class='col-md-4'>
							...
							<?php endforeach;?>
							<?php if($savee): ?>
									<a href='<?=base_url();?>jobs_recruit/job_unsaved_search/<?=$row->user_id?>' class='btn btn-default pull-right mb5 mt20' style='width:80%'>Unsave</a>
							<?php endif; ?>
							<?php if(!$savee): ?>
							...
							<?php endif; ?>											
								...
								<?php endforeach; ?>							
					<?php endif; ?>
					<?php if($candidatesavesquery->num_rows() < 1): ?>
				...
				<div class="col-sm-4 page-sidebar">
						<aside>
								<div class="widget sidebar-widget white-container brown-container links-widget">
									<ul>
										<li><a href='<?=base_url();?>jobs_recruit/job_cv_search'>Search for CVs</a></li>
										<li><a href='<?=base_url();?>jobs_recruit/job_candidates_cv_downloaded'>Downloaded Profile</a></li>
				                    	<li class='active'><a href='#'>Saved Search</a></li>
				                    </ul>
				                </div>
				        </aside>
				</div>
