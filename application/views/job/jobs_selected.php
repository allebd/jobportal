		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-8 page-content">
					...
					<?php if($jobselectquery->num_rows() > 0): ?>
								<?php foreach($jobselectquery->result() as $row): ?>
								<?php if(strtotime('now') > strtotime($row->job_end_date)):?>
									<?php 
											$this->db->where('job_id', $row->job_id);
											$this->db->delete('job');	
											$this->db->where('job_id', $row->job_id);
					...
					<div class="jobs-item with-thumb">
						<div class="clearfix mb30">							
							<a href="<?=base_url();?>jobs" class="btn btn-gray">View All Jobs</a>							
						</div>
