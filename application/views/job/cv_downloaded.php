			...
			<div class="row">
				<div class="col-sm-8 page-content">
					<div class="title-lines">
						<h4 class="mt0">Downloaded Candidates</h4>
					</div>
					...
					<?php if($candidatedownloadquery->num_rows() > 0): ?>
								<?php foreach($candidatedownloadquery->result() as $row): ?>
					<div class="jobs-item with-thumb row brown-container">
						...
						<div class='col-md-4'>
							...
							<?php endif; ?>											
								...
								<?php endforeach; ?>							
					<?php endif; ?>
					<?php if($candidatedownloadquery->num_rows() < 1): ?>
						<p>No candidate downloaded</p>
					<?php endif; ?>	
						...
						<aside>
								<div class="widget sidebar-widget white-container brown-container links-widget">
									<ul>
										...
										<li class='active'><a href='#'>Downloaded Profile</a></li>
