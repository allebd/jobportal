			...
			<div class="row">
				...
				<div class="col-sm-8 page-content">
					<div class="jobs-item">
						...
						<?php echo form_open_multipart('profile_admin/article_edit_update'); ?>
							<h5 class="bottom-line mtm3">Edit Article
								<span class="pull-right">
									<input type='submit' class='btn btn-gray' value='Save' id='candidate-cert-save' />
									<a href="<?=base_url();?>profile_admin/manage_articles" class="btn btn-gray" id='candidate-cert-cancel'>Cancel</a>
								</span>
							</h5>
								<table id='recruiter-desc-general'>
									<tbody>
										<?php foreach($article_edit->result() as $row): ?>
										<tr>
										...
										<tr>
											<td>Author</td>
											<td><?php echo form_input('author', set_value('author',$row->author), 'id="author" class="form-control"');?></td>
										</tr>
										<tr>
											<td>Article body</td>
											<td><?php echo form_textarea('body', set_value('body',$row->body), 'id="body" class="form-control"');?>
												<script>
										...
										<tr>
											...
											<td>
												<?php echo form_hidden('cover_photo', $row->cover_photo); ?>
												<p><img src='<?=base_url()?>uploads/<?=$row->cover_photo?>' width='125' height='125'></p>
												<p>
