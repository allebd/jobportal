			...
			<div class="row">
					...
					<aside>
						<div class="widget sidebar-widget white-container brown-container links-widget">
							<ul>
								...
								<li class="active"><?=anchor('profile_admin/manage_team', 'About Team');?></li>
				...
				<div class="col-sm-8 page-content">
					<div class="jobs-item jobs-single-item">
						<?php echo form_open_multipart('profile_admin/team_edit_update'); ?>
							<h5 class="bottom-line mtm3">Edit Team member
								<span class="pull-right">
									<input type='submit' class='btn btn-gray' value='Save' id='candidate-cert-save' />
									<a href="<?=base_url();?>profile_admin/manage_team" class="btn btn-gray" id='candidate-cert-cancel'>Cancel</a>
								</span>
							</h5>
								<table id='recruiter-desc-general'>
									<tbody>
										<?php foreach($team_edit->result() as $row): ?>
										<tr>
										...
										<tr>
											<td>Picture</td>
											<?php if($row->team_picture != ''):?>
											<?php echo form_hidden('team_picture', $row->team_picture); ?>
											<td><p><img src='<?=base_url()?>uploads/<?=$row->team_picture?>' width='125px' height='125px'></p>
												<p>
