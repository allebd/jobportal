			...
			<div class="row">
				...
				<div class="col-sm-8 page-content">
					<div class="jobs-item jobs-single-item">
							<h5 class="bottom-line mtm3">Manage Welcome Messages</h5>
								<table id='recruiter-desc-general'>
									<tbody>
										...
										<?php foreach($welcomemsg->result() as $row): ?>
										<tr>
											<td><?=$row->name?></td>
											<td><a href="<?=base_url();?>profile_admin/welcome_message_edit/<?=$row->welcome_id?>" class="btn btn-gray fa fa-edit" title='Edit'></a></td>										
										<?php endforeach; ?>	
										</tr>																							
									</tbody>
								</table>						
