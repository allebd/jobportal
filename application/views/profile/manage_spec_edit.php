			...
			<div class="row">
				...
				<div class="col-sm-8 page-content">
					<div class="jobs-item jobs-single-item">
						...
						<?php echo form_open_multipart('profile_admin/spec_edit_update'); ?>
							<h5 class="bottom-line mtm3">Edit Specialization
								<span class="pull-right">
									<input type='submit' class='btn btn-default' value='Save' id='candidate-cert-save' />
									<a href="<?=base_url();?>profile_admin/manage_spec" class="btn btn-gray" id='candidate-cert-cancel'>Cancel</a>
								</span>
							</h5>
								<table id='recruiter-desc-general'>
									<tbody>
										<?php foreach($specialization_edit->result() as $row): ?>
										<tr>
