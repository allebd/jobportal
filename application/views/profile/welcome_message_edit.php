			...
			<div class="row">
					...
					<aside>
						<div class="widget sidebar-widget white-container brown-container links-widget">
							<ul>
								...
								<li class="active"><?=anchor('profile_admin/welcome_message', 'Welcome Message');?></li>
				...
				<div class="col-sm-8 page-content">
					<div class="jobs-item">
						...
						<?php echo form_open_multipart('profile_admin/welcome_message_update'); ?>
							<h5 class="bottom-line mtm3">Edit Welcome Message
								<span class="pull-right">
									<input type='submit' class='btn btn-gray' value='Save' id='candidate-cert-save' />
									<a href="<?=base_url();?>profile_admin/welcome_message" class="btn btn-gray" id='candidate-cert-cancel'>Cancel</a>
								</span>
							</h5>
								<table id='recruiter-desc-general'>
									<tbody>
										<?php foreach($welcomemsg_edit->result() as $row): ?>
										<tr>
											<td>Name</td>
											<td><?=$row->name?></td>
										</tr>
										...
										<tr>
											<td>Message</td>
											<td><?php echo form_textarea('welcome_message', set_value('welcome_message',$row->welcome_message), 'id="welcome_message" class="form-control"');?>
