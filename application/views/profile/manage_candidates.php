				...
				<div class="col-sm-8 page-content">
					...
					<div class="jobs-item jobs-single-item">
							<div class="clearfix mb30">							
								<a href="<?=base_url();?>profile_admin/manage_candidates_new" class="btn btn-gray">View New Applicants</a>							
							</div>						
							...
							<?php if($candidatesearchquery->num_rows() > 0): ?>
									<?php foreach($candidatesearchquery->result() as $row): ?>
									...
									<?php endforeach; ?>							
							<?php endif; ?>
							<?php if($candidatesearchquery->num_rows() < 1): ?>
