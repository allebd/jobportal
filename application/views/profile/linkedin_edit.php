			...
			<div class="row">
				...
				<div class="col-sm-8 page-content">
					<div class="jobs-item jobs-single-item">
						<?php echo form_open_multipart('profile_admin/linkedin_edit_update'); ?>
							<h5 class="bottom-line mtm3">Edit LinkedIn Link
								<span class="pull-right">
									<input type='submit' class='btn btn-gray' value='Save' id='candidate-cert-save' />
									<a href="<?=base_url();?>profile_admin/manage_social" class="btn btn-gray" id='candidate-cert-cancel'>Cancel</a>
								</span>
							</h5>
								<table id='recruiter-desc-general'>
									<tbody>
										<?php foreach($linkedin_edit->result() as $row): ?>
										<tr>
										...
										<tr>
											<td>Link</td>
											<td><?php echo form_input('link', set_value('link',$row->link), 'id="link" class="form-control"');?></td>
										</tr>
										<?php endforeach; ?>																									
									</tbody>
								</table>
