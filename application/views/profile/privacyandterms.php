			...
			<div class="row">
				...
				<div class="col-sm-8 page-content">
					<div class="jobs-item jobs-single-item">
							<h5 class="bottom-line mtm3">Manage Privacy, Terms &amp; Conditions</h5>
								<table id='recruiter-desc-general'>
									<tbody>
										...
										<?php foreach($privacyandterms->result() as $row): ?>
										<tr>
											<td><?=$row->name?></td>
											<td><a href="<?=base_url();?>profile_admin/privacyandterms_edit/<?=$row->extra_id?>" class="btn btn-gray fa fa-edit" title='Edit'></a></td>										
										<?php endforeach; ?>	
										</tr>																							
									</tbody>
								</table>						
