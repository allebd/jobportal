		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-8 page-content">
					<div class="jobs-item">
						<?php echo form_open_multipart('profile_admin/trainings_edit_download_update'); ?>
							<h5 class="bottom-line mtm3">Edit Training Download
								...
								<table id='recruiter-desc-general'>
									<tbody>
										...
										<tr>
											<td>Document/Brochure</td>
											<?php if($row->docone != ''):?>
											<?php echo form_hidden('docone', $row->docone); ?>
											<td>
												<p><?=$row->docone?></p>
												<p>
