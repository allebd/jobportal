				...
				<div class="col-sm-8 page-content">
					<div class="candidates-item candidates-single-item">
						<?php echo form_open('profile/candidates_career_insert'); ?>
								<h4 class="bottom-line mtm3">Career Details <span class="pull-right">
									<input type='submit' class='btn btn-gray' value='Save'/>
									<a href="<?=base_url()?>profile/candidates_area" class="btn btn-gray">Cancel</a></span></h4>
								...
								<table class='mtm3'>
									<tbody>
										...
										<tr>
											<td>Skills</td>
											<td><input type='text' name='skill' id='skill' value='<?=$row->skill;?>' class='form-control' data-suggestions="<?php foreach($skills->result() as $skillrow):?><?=$skillrow->name?>,<?php endforeach; ?>">
											</td>
										</tr>
										
										<tr>
											<td>Expected Salary <br><sub><strong>Please be realistic with your<br>minimum expected monthly<br>salary in other to enhance<br> your opportunities)</strong></sub></td>
