			...
			<div class="row">
				...
				<div class="col-sm-8 page-content">
					<div class="jobs-item jobs-single-item">
						...
						<?php echo form_open_multipart('profile_admin/testimony_edit_update'); ?>
							<h5 class="bottom-line mtm3">Edit Testimony
								<span class="pull-right">
									<input type='submit' class='btn btn-gray' value='Save' id='candidate-cert-save' />
									<a href="<?=base_url();?>profile_admin/manage_testimonies" class="btn btn-gray" id='candidate-cert-cancel'>Cancel</a>
								</span>
							</h5>
								<table id='recruiter-desc-general'>
									<tbody>
										<?php foreach($testimony_edit->result() as $row): ?>
										<tr>
										...
										<tr>
											<td>Company</td>
											<td><?php echo form_input('company', set_value('company',$row->company_name), 'id="company" class="form-control"');?></td>
										</tr>
										<tr>
											<td>Testimony</td>
											<td><?php echo form_textarea('testimony', set_value('testimony',$row->body), 'id="testimony" class="form-control"');?></td>
										</tr>
										<tr>
											<td>Display on homepage</td>
											<td><?php echo form_checkbox('homedisplay', 'accept', $row->homedisplay); ?>
											</td>
										</tr>
										<tr>
											<td>Picture</td>
