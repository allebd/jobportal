			...
			<div class="row">
				...
				<div class="col-sm-8 page-content">
					<div class="jobs-item jobs-single-item">
						...
						<?php echo form_open_multipart('profile_admin/salary_insert'); ?>
							<h5 class="bottom-line mtm3">Manage Salary
									<span class="pull-right">
										<a href="#" class="btn btn-gray" id='recruiter-desc-edit'>Add Salary</a>
								...
								<table id='recruiter-desc-general'>
									<tbody>
										...
										<tr>
											<td><?=$row->name?></td>
											<td><a href="<?=base_url();?>profile_admin/salary_edit/<?=$row->id?>" class="btn btn-gray fa fa-edit" title='Edit'></a></td>
											<td><a href="<?=base_url();?>profile_admin/salary_delete/<?=$row->id?>" class="btn btn-gray fa fa-trash-o" title='Delete'></a></td>
										</tr>
										<?php endforeach; ?>																									
									</tbody>
								</table>
