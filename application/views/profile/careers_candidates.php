			...
			<div class="row">
				...
				<div class="col-sm-8 page-content">
					...
					<div class="jobs-item jobs-single-item">
							...
							<a href="<?=base_url();?>profile_admin/manage_careers" class="btn btn-gray">View all Careers</a>
							
							</div>						
							<h5 class="bottom-line mtm3">Manage Candidates</h5>
							<?php if($careerscandidatesearchquery->num_rows() > 0): ?>
									<?php foreach($careerscandidatesearchquery->result() as $row): ?>
									...
									<?php endforeach; ?>							
							<?php endif; ?>
							<?php if($careerscandidatesearchquery->num_rows() < 1): ?>
