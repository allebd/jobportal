				...
				<div class="col-sm-8 page-content">
					<div class="jobs-item jobs-single-item">
						<div class="clearfix mb30">
							...
							<a href="<?=base_url();?>profile_admin/manage_admins" class="btn btn-gray">View Enabled Admins</a>
							...
							<h5 class="bottom-line mtm3">Manage Admins
								...
								<table id='recruiter-desc-general'>
									<tbody>
										...
										<?php foreach($admindisabledquery->result() as $row): ?>
										<tr>
											<td><?=$row->admin_surname?> <br><span><?=$row->admin_username?></span></td>
											<td><?=$row->admin_firstname?></td>
											<td><a href="<?=base_url();?>profile_admin/admin_disable_delete/<?=$row->admin_id?>" class="btn btn-gray fa fa-trash-o" title='Delete'></a></td>
											<td><a href="<?=base_url();?>profile_admin/admin_enable/<?=$row->admin_id?>" class="btn btn-gray fa fa-exclamation" title='Enable'></a></td>
										</tr>
										<?php endforeach; ?>																									
									</tbody>
								</table>												
