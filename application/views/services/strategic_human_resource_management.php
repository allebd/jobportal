			...
			<div class="row">
				<div class="col-sm-8 page-content">
					<div class="white-container mb0">
						<h4>Strategic Human Resource Management</h4><br>

						<p><img src="<?=base_url();?>img/service-strategic.jpg" alt="" width="100%"></p><br>
						
						<p><?=$serviceone;?></p>

						<p>MPS's Strategic HRM consulting focuses on:</p>						
						<ul>
							<li>Building efficient workforces to generate globalization, growth and company success</li>
							<li>Quantifying the effect of workforce program application on company results</li>
							<li>Developing the talent management's procedures to support leadership, employees and company objectives / design.</li>							
						</ul>	
					</div>
				</div>
					...
					<aside>
						<div class="widget sidebar-widget white-container brown-container links-widget">
							<ul class='service'>
								...
								<li class="strategic active"><?=anchor('services/strategic_human_resource_management', 'Strategic Human Resource Management');?></li>
