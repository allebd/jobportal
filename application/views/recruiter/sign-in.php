												...
												<div class="widget-content">
													...
													<?php echo form_open('recruitlogin/validate_credentials'); ?>
														...
														<div class="text-center">
															...
															<p class='mt20 text-center' style='color:white'><a style='color:white' href='<?=base_url()?>recruitlogin/forgotpassword'>Forgot Password?</a></p>
															<p class="text-center" style='color:white'>Don't have an account yet? What are you waiting for?</p>
															<h5 class="text-center"><a href='<?=base_url()?>recruitlogin/register' >Register Here</a></h5>
												...
												<div class="widget-content">
													...
													<?php echo form_open('recruitlogin/validate_credentials'); ?>
														...
														<div class="text-center">
															...
															<h5 class="text-center"><a href='#' class='dshow'>Register Here</a></h5>
											...
											<div class="widget sidebar-widget white-container black-container">
												...
												<div class="widget-content">
													<?php echo form_open('recruitlogin/register'); ?>
														...
														<div class="form-group">
															<input type='checkbox' id='checkmes' name='terms' value=''><span class='m5'></span><span><a href='<?=base_url();?>recruiter/terms_download/<?=$terrows->upload?>'>Terms &amp Conditions</a></span>
														</div>
														<?php endforeach;?>

														<div class="text-center">
															<button type="submit" class="btn btn-default" id='registeraccts' disabled='disabled'>Register</button>
														</div>
															<br>
															<p class="text-center" style='color:white'>Already have an account?</p>
															<h5 class="text-center"><a href='#' class='dhide'>Sign In</a></h5>
